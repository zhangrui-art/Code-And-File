...
.baseTopicItem .txt .left {
  display: flex;
}
.baseTopicItem .txt .left p {
  margin-right: 20px;
}
.baseTopicItem .txt .left .red {
  color: #AA2113;
}
.baseTopicItem .info {
  position: absolute;
...
.baseTopicItem .info .left {
  padding-top: 20px;
  color: #fff;
}
.baseTopicItem .info .left h5 {
  margin-bottom: 5px;
  font-size: 20px;
}
.baseTopicItem .info .right {
  margin-top: 35px;
  padding: 0 7px;
  height: 25px;
  line-height: 25px;
