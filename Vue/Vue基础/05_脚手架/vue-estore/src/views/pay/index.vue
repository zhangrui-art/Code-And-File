  ...
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="selectAddress.address_id">
        ...
        <div class="info-address">
          {{ selectAddress.region.province }} {{ selectAddress.region.city }} {{ selectAddress.region.region }} {{ selectAddress.detail }}
        </div>
      </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!selectAddress.region_id">请先选择配送地址</span>
